 ...
 * Usage: <OAuthButtons onOAuth={(provider) => handleOAuth(provider)} />
 * provider will be 'google' | 'github' | 'microsoft'
 */
export function OAuthButtons({ onOAuth, providers = PROVIDERS, className }) {
  return (
