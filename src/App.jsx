/**
 * VA Studio Frontend — Finance Standalone
 *
 * This is a standalone version of the Finance template.
 * It renders the Finance template directly as the main interface.
 *
 * Routes:
...
import TemplateApp from '../templates/finance/App.jsx'
...
/* ------------------------------------------------------------------ */
/*  Home Page (Finance Template with Connectivity Banner)       */
/* ------------------------------------------------------------------ */
